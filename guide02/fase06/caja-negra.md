...
|---------------------|---------|----------------------------|------------|--------------------|-----------|-----------|
| RF01 - Gestión de Productos | CU01 | No permitir el registro de productos sin SKU | SKU: Vacío / Los demás campos fueron llenados | El producto no se registra | <img width="1019" height="519" alt="image" src="https://github.com/user-attachments/assets/891988ad-73f4-4fb8-aea3-5b3c24947ade" />
 | Ok |
| RF02 - Gestión de Inventario | CU02 | Disminuir el stock al realizar una venta | F2C4 | F2C5 | F2C6 | F2C7 |
